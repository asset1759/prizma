...
export const es: Dict = {
  ...
  statsWeek: 'Semana',
  statsStreak: 'Racha',
  statsBest: 'Más a menudo',
  statsBestPhrase: 'Sueles empezar hacia las {hour}',
  statsEmpty: 'Tu primera sesión aún está por llegar. Vuelve cuando termines una fase: entonces habrá algo que mirar.',
  sessionsOne: '{n} sesión',
  sessionsFew: '{n} sesiones',
  sessionsMany: '{n} sesiones',
  daysOne: '{n} día seguido',
  daysFew: '{n} días seguidos',
  daysMany: '{n} días seguidos',
  unitH: 'h',
  unitMin: 'min',
  statsTitle: 'Progreso',
