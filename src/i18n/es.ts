...
export const es: Dict = {
  ...
  appsTitle: 'Apps',
  appsHint:
    'Aquí vivirán los conjuntos de apps: redes sociales, juegos, todo menos las llamadas. Por ahora la lista se elige en la pantalla del sistema al activar Deep Focus.',
  statsTitle: 'Resumen',
