...
/**
 * Англоязычные регионы, где часы пишут по двенадцать.
 *
 * Список решает судьбу только английского интерфейса — почему, см.
 * `uses12Hour` ниже. Поэтому здесь нет ни Мексики, ни Египта: писать
 * их сюда значило бы держать строки, которые ни на что не влияют.
 * Великобритании и Ирландии тоже нет — там пишут 24 часа.
 */
const HOUR12 = new Set([
  'US', 'CA', 'AU', 'NZ', 'PH', 'IN', 'PK', 'BD', 'MY',
]);
...
/**
 * Писать ли часы по двенадцать.
 *
 * Решает сначала язык, и только потом регион. «Чаще всего с 9 AM до
 * 11 AM» — русская фраза с английской пометкой, и читается она как
 * недоделка, сколько бы правды ни было в том, что человек живёт в
 * Нью-Йорке. Английскому же AM/PM не мешает нигде, так что внутри
 * английского спрашиваем регион: американец получит «2:25 PM»,
 * британец — «14:25».
 *
 * Цена решения названа честно: американец, переключивший интерфейс на
 * испанский, увидит 24 часа. Ровный текст того стоит — он читается
 * каждый раз, а несовпадение с привычкой замечают однажды.
 */
export function uses12Hour(lang: Lang): boolean {
