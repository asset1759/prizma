...
export const de: Dict = {
  ...
  statsWeek: 'Woche',
  statsStreak: 'Serie',
  statsBest: 'Am häufigsten',
  statsBestPhrase: 'Du beginnst meist gegen {hour}',
  statsEmpty: 'Deine erste Sitzung steht noch bevor. Komm wieder, wenn eine Phase durch ist — dann gibt es etwas zu sehen.',
  sessionsOne: '{n} Sitzung',
  sessionsFew: '{n} Sitzungen',
  sessionsMany: '{n} Sitzungen',
  daysOne: '{n} Tag in Folge',
  daysFew: '{n} Tage in Folge',
  daysMany: '{n} Tage in Folge',
  unitH: 'Std',
  unitMin: 'Min',
