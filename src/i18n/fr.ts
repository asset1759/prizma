...
export const fr: Dict = {
  ...
  statsWeek: 'Semaine',
  statsStreak: 'Série',
  statsBest: 'Le plus souvent',
  statsBestPhrase: 'Vous commencez le plus souvent vers {hour}',
  statsEmpty: 'Votre première session est encore devant vous. Revenez quand une phase sera terminée : il y aura alors de quoi regarder.',
  sessionsOne: '{n} session',
  sessionsFew: '{n} sessions',
  sessionsMany: '{n} sessions',
  daysOne: '{n} jour d’affilée',
  daysFew: '{n} jours d’affilée',
  daysMany: '{n} jours d’affilée',
  unitH: 'h',
  unitMin: 'min',
